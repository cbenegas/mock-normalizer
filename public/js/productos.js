...
function updateProducto(idProd) {
    ...
    if (productos.length > 0) {
        ...
        for (const prod of productos) {
            html += `
                    ...
                    <td><a type="button" onclick="deleteProducto('${prod.id}')">delete</a></td>
                    <td><a type="button" onclick="updateProducto('${prod.id}')">update</a></td>
                    </tr>`
        }
        html += `
            </table>
